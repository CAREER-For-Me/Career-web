      ...
      <div className="flex m-9 flex-col ">
        ...
        <div className="flex mb-4 items-center h-6 relative">
          ...
          <div className="absolute left-[10rem]">
            <BarChart value={myspec?.majorScore || 0} max={4.5} />
          </div>
        ...
        <div className="flex mb-4 items-center h-6 relative">
          ...
          <div className="bg-gray-light w-[18.8rem] h-[0.6rem] absolute left-[10rem] rounded-full" />
          <div className="absolute left-[10rem]">
            <BarChart value={myspec?.internCount || 0} max={5} />
          </div>
        ...
        <div className="flex mb-4 items-center h-6 relative">
          ...
          <div className="bg-gray-light w-[18.8rem] h-[0.6rem] absolute left-[10rem] rounded-full" />
          <div className="absolute left-[10rem]">
            <BarChart value={myspec?.awardCount || 0} max={5} />
          </div>
        ...
        <div className="flex mb-4 items-center h-6 relative">
          ...
          <div className="bg-gray-light w-[18.8rem] h-[0.6rem] absolute left-[10rem] rounded-full" />
          <div className="absolute left-[10rem]">
            <BarChart value={myspec?.qualCount || 0} max={5} />
          </div>
        ...
        <div className="flex mb-4 items-center h-6 relative">
          ...
          <div className="bg-gray-light w-[18.8rem] h-[0.6rem] absolute left-[10rem] rounded-full" />
          <div className="absolute left-[10rem]">
            <BarChart value={myspec?.toeicScore || 0} max={990} />
          </div>
